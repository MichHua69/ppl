...
var HSComboBox = class _HSComboBox extends HSBasePlugin {
  constructor(el, options) {
    ...
    this.outputItemTemplate = (concatOptions == null ? void 0 : concatOptions.outputItemTemplate) ?? `<div class="cursor-pointer py-2 px-4 w-full text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-gray-200 dark:focus:bg-slate-800" data-hs-combo-box-output-item>
    ...
    this.outputEmptyTemplate = (concatOptions == null ? void 0 : concatOptions.outputEmptyTemplate) ?? `<div class="py-2 px-4 w-full text-sm text-gray-800 rounded-lg dark:bg-slate-900 dark:text-gray-200">Nothing found...</div>`;
    this.outputLoaderTemplate = (concatOptions == null ? void 0 : concatOptions.outputLoaderTemplate) ?? `<div class="flex justify-center items-center py-2 px-4 text-sm text-gray-800 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-200">
...
var HSOverlay = class _HSOverlay extends HSBasePlugin {
  constructor(el, options, events) {
    ...
    this.backdropClasses = (concatOptions == null ? void 0 : concatOptions.backdropClasses) ?? "transition duration fixed inset-0 bg-gray-900 bg-opacity-50 dark:bg-opacity-80 hs-overlay-backdrop";
