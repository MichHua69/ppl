  ...
  <section class="h-full" >
    ...
    <div class="flex flex-col justify-center w-screen bg-cover bg-center h-screen m-xl bg-primary px-36 gap-10">
      ...
      <div class="flex gap-7">
        ...
        <button onclick="location.href='/peternak/infromasidanprogram'" class="flex flex-col bg-secondary hover:bg-primary hover:text-secondary text-primary items-center justify-center font-bold rounded-xl relative bg-no-repeat w-[13rem] h-[13rem] ">
          <img
              class="h-36"
